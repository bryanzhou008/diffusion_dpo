...
num_images = 9
guidance_scale = 7.5
OUTPUT_DIR = "/local1/bryanzhou008/Dialect/multimodal-dialectal-bias/mitigation/baselines/diffusion_dpo/chamaca_out"
os.makedirs(OUTPUT_DIR, exist_ok=True)

# Define models: For the base model, ckpt is None.
model_dict = {
    "Orig_SD15": None,
    "DPO_SD15_lr1e-8": "/local1/bryanzhou008/Dialect/multimodal-dialectal-bias/mitigation/baselines/diffusion_dpo/tmp-sd15-dialect-chamaca/checkpoint-2500",
...
dialect_prompt = "a chamaca at a school"
sae_prompt = "a little girl at a school"
general_prompts = [
